...
public class Settings {
	...
	/** Block height range to scan for trimmable AT states. This has a significant effect on execution time. */
	...
	/** Block height range to scan for trimmable online accounts signatures. This has a significant effect on execution time. */
	...
	/** Create bootstrap on core start before other instances use db */
	private boolean bootstrapOnStart = false;

	/** Whether we should prune old data to reduce database size. This prevents the node from being able to serve older blocks.
	 * No longer used
	*/
	...
	/** Block height range to scan for prunable AT states. This has a significant effect on execution time. */
	...
	/** Block height range to scan for prunable blocks. This has a significant effect on execution time. */
